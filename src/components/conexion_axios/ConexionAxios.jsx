...
import md5 from 'md5'
const base_url='http://localhost:5000/hashima/'
const base_url_2='http://localhost:5000/data/'


export const minarHashima=async(diff,_hashString)=>{
    var paso=false
    var estrellas=0
    var hash_calculado=''
    var nonce=''
    
    await axios.get(base_url+diff.toString()+"/"+_hashString).then(
        result=>{
